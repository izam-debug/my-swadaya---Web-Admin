...
<div id="right-sidebar" class="settings-panel">
  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"> <a class="nav-link" href="/master/data-pelanggan">Pelanggan</a></li>
          @endif
          <li class="nav-item"> <a class="nav-link" href="/master/harga-air">Harga Air</a></li>
          @if (auth()->check() && auth()->user()->level == 'super admin')
          <li class="nav-item"> <a class="nav-link" href="/master/data-petugas">Petugas</a></li>
          @endif
        </ul>
      </div>
    </li>
    <hr>
    <li class="nav-item">
      <a class="nav-link" href="/siarkan">
        <i class="menu-icon mdi bi bi-megaphone"></i>
        <span class="menu-title">Siarkan Tagihan</span>
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="/tagihan">
        <i class="menu-icon mdi bi bi-receipt"></i>
